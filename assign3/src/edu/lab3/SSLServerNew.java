...
public class SSLServerNew {
    ...
    public static class MyHandler implements HttpHandler {
        ...
        public void handle(HttpExchange t) throws IOException {
            ...
            System.out.println(Arrays.toString(httpsExchange.getSSLSession().getLocalCertificates()));
            System.out.println("*");
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            FileInputStream fis = new FileInputStream("testkeyserver.jks");
